            ...
            <div className="mx-auto md:px-5 max-w-full ">
                <div className="flex justify-between h-80 overflow-hidden mx-16 rounded-xl">
                    <div className="w-2/5 md:w-1/2 text-end">
                        <img src={darkMode ? props.dark : props.light} width="547px" height="320px" className="w-full h-full object-cover" alt={`3D image of a ${props.alt}`} loading="lazy" decoding="async"/>
                    </div>
