                ...
                {groundsDetails && (
                    <div className="mx-8">
                        ...
                        <div className="flex flex-col justify-center items-start">
                            ...
                            <p className="campground-text mt-10 md:mt-16"><span className="campground-span">Weather:</span> {groundsDetails.weatherOverview}</p>

                            <p className="campground-text mt-8 md:mt-16"><span className="campground-span">Total campsites:</span> {groundsDetails.campsites.totalSites}</p>

                            <p className="campground-span mt-8 md:mt-16">Fees</p>
                            ...
                            <p className="campground-span mt:8 md:mt-16">Amenities</p>
                            ...
                            <p className="campground-span mt-8 md:mt-16">Directions</p>
