        ...
        <div className={`${darkMode && "dark"}`}>
            <div className="w-full">
                <div className="flex items-center justify-center relative">
                    <picture>
                        <source srcSet="/src/assets/images/hero-night.webp" media="(prefers-color-scheme: dark)" type="image/webp" />
                        <source srcSet="/src/assets/images/day-hero.webp" media="(prefers-color-scheme: light)" type="image/webp" />
                        <img 
                            src="/src/assets/images/day-hero.webp" 
                ...
                <div className="my-10 md:my-20 mx-8 md:mx-16">
                    ...
                    <div className="w-full flex gap-4">
                        <div className="w-1/2">
                            <img src={tentB1} className="rounded-lg w-full" loading="lazy" />
                        </div>
                        <div className="w-1/2">
                            <img src={tentB2} className="rounded-lg w-full" loading="lazy" />
                        </div>
                    </div>
