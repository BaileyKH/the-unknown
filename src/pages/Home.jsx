            ...
            <div className="w-full">
                <div className="flex items-center justify-center">
                    ...
                    <div className="absolute bg-white/90 dark:bg-black/90 rounded-md px-4 md:px-8 py-4 mx-4 drop-shadow-2xl">
                        ...
                        <h1 className="text-color text-2xl md:text-4xl lg:text-6xl font-bold drop-shadow-md">Adventure into the Unknown</h1>
                        <p className="text-color text-lg lg:text-xl mt-2">Keep exploring with all the latest gear from the brands you love!</p>
                        <Link to="/">
                            <button className="mt-6 bg-lime-500 dark:bg-amber-700 rounded-md text-color font-bold lg:text-lg px-4 py-2 tracking-wide">Shop Now</button>
                        </Link>
                    </div>
                </div>
                <h1>Body</h1>
