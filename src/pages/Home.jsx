            ...
            <div className="w-full">
                ...
                <div className="my-10 md:my-20 mx-8 md:mx-16">
                    ...
                    <div className="w-full flex gap-4">
                        <div className="w-1/2">
                            <img src={tentB1} className="rounded-lg w-max-[700px] h-auto" decoding="async"/>
                        </div>
                        <div className="w-1/2">
                            <img src={tentB2} className="rounded-lg w-max-[700px] h-auto" decoding="async"/>
                        </div>
                    </div>
                ...
                <div className="flex justify-center overflow-hidden h-80 w-full mt-8 md:mt-16">
                    <img src={explore} className="relative w-full h-auto object-cover brightness-50" loading="lazy" alt="camping tent overlooking beautiful mountain side" decoding="async"/>
