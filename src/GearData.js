...
export default gearData = () => [
    {
        name: "AdventurePro 4-Person Dome Tent",
    ...
    {
        name: "SummitPeak 2-Person Ultralight Tent",
    ...
    {
        name: "TrailBlazer 3-Person Instant Cabin Tent",
    ...
    {
        name: "EverestExpedition 6-Person Family Tent",
    ...
    {
        name: "Pioneer 50L Trekking Backpack",
    ...
    {
        name: "Expedition 65L Pro Backpack",
    ...
    {
        name: "Ultralight 45L Venture Backpack",
    ...
    {
        name: "TrailGuardian 15°F Expedition Sleeping Bag",
    ...
    {
        name: "EcoExplorer 30°F Recycled Sleeping Bag",
    ...
    {
        name: "MountainDreamer 20°F Mummy Sleeping Bag",
    ...
    {
        name: "SummitLite 40°F Ultralight Sleeping Bag",
    ...
    {
        name: "TrailMaster Stainless Steel Camping Mug",
    ...
    {
        name: "PeakFlame Portable Camping Stove",
    ...
    {
        name: "CampChef 5-Piece Nonstick Camping Pan Set",
    ...
    {
        name: "TrailEats 8-Piece Camping Plate & Silverware Set",
    ...
    {
        name: "VanLife Adventure T-Shirt",
    ...
    {
        name: "EcoTrail All-Weather Jacket",
    ...
    {
        name: "SummitPro Waterproof Hiking Boots",
